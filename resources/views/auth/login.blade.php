    ...
    <div class="dust-paarticle">
        ...
        <svg width="100%" id="dust-paarticle" height="100%" viewBox="0 0 885 455" fill="none"
            ...
            <path d="M207.6 286.9V294.6" stroke="#E03F8D" stroke-width="2" stroke-miterlimit="10"
                stroke-linecap="round" stroke-linejoin="round" />
            <path d="M165.9 402.7H176.2" stroke="#1DB7C2" stroke-width="2" stroke-miterlimit="10"
                stroke-linecap="round" stroke-linejoin="round" />
            <path d="M171 397.5V407.9" stroke="#1DB7C2" stroke-width="2" stroke-miterlimit="10"
                stroke-linecap="round" stroke-linejoin="round" />
            <path
                        ...
                        <div class="authfy-panel panel-login text-center active">
                            <div class="authfy-heading">
                                ...
                                <p>Don’t have an account? <a class="lnk-toggler" data-panel=".panel-signup"
                                        href="{{ route('register') }}">Sign Up Free!</a></p>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    <form name="loginForm" class="loginForm" action="{{ route('login') }}"
                                        ...
                                        <div class="form-group">
                                            <button class="btn btn-lg btn-primary btn-block">Login with
                                                email</button>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    ...
                                    <form name="forgetForm" class="forgetForm" action="#" method="POST">
                                        ...
                                        <div class="form-group">
                                            <button class="btn btn-lg btn-primary btn-block" type="submit">Recover
                                                your password</button>
                                        </div>
                                        <div class="form-group">
                                            <a class="lnk-toggler" data-panel=".panel-login" href="#">Already
                                                have an account?</a>
                                        </div>
                                        <div class="form-group">
                                            <a class="lnk-toggler" data-panel=".panel-signup" href="#">Don’t
                                                have an account?</a>
                                        </div>
                                    </form>
                                </div>
            ...
            <g id="XMLID5">
                <g id="eye2">
                    ...
                    <g id="XMLID63">
                        <path id="Vector_3"
                            d="M45.7 128.6C40.6 128.2 35.5 127.8 30.4 127.4C33 107.8 31.8 88.1 27.2 69.3C30.8 68.3 34.4 67.2 38 66.1C44.4 85.9 47.1 107.1 45.7 128.6Z"
                            stroke="#2A2A2A" stroke-width="6" stroke-miterlimit="10" stroke-linecap="round"
                            stroke-linejoin="round" />
                    </g>
                    <g id="XMLID44">
                        <g id="XMLID 49">
                ...
                <path id="XMLID 56"
                    ...
                    stroke="#2A2A2A" stroke-width="6" stroke-miterlimit="10" stroke-linecap="round"
                    stroke-linejoin="round" />
                <path id="XMLID 55" d="M45.3 158.8C45.6 159.1 50.4 163.7 51.7 168.5" stroke="#2A2A2A"
                ...
                <path id="XMLID 23" opacity="0.39"
                    ...
                    fill="#FFFFFB" />
                <path id="XMLID 229" opacity="0.39"
                ...
                <g id="XMLID 18">
                    ...
                    <g id="XMLID 223">
                        <path id="XMLID 19" opacity="0.49"
                            ...
                            fill="#AAD543" />
                        <path id="XMLID 224" opacity="0.49"
                ...
                <g id="Group">
                    ...
                    <path id="XMLID 6" opacity="0.29"
                        ...
                        fill="#E41B64" />
                    <path id="XMLID 202" opacity="0.29"
